...
export const projectsData = [
  {
    ...
    img: 'project.PNG',
    title: 'Robofriends',
    info: 'This web app allows users to search for different Robot names and thier corresponding profile is displayed. Robofriends was created using React.js. it is fully responsible.',
  ...
  },
  {
    ...
    info: "Facerecognition app accepts image url and detects the face in the picture.The front end uses React.js, an image recognition Api. I'ts server uses Node and Express and it also has i'ts own database.",
  ...
  },
  {
    ...
    info: "Bovato Block Industry is a physical block industry that wants i'ts products and services displayed virtually for users across the world.",
